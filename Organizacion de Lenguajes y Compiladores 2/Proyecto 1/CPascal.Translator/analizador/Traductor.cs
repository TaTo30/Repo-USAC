...
class Traductor : Grammar
{
    public Traductor() : base(false){
        ...
        instruccion.Rule
            ...
            | array + ASG + expresion + PTCOMA //4
            | RGRAFICAR + PARA + PARC + PTCOMA //4
        ...
        sentenciaCase.Rule
            = RCASE + PARA + expresion + PARC + ROF + caseValue + REND;
        ...
        listaconstante.Rule
            = listaconstante + IDENTIFICADOR + EQ + expresion + PTCOMA//4
