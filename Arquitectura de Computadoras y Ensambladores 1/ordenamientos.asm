...
LOCAL CICLO, REPEAT
    ...
    xor dx, dx ;donde voy contar
    CICLO:
        mov [di], 0Fh ;poner colo negro
        inc di
        inc dx
        cmp dx, 60
        jne REPEAT
        xor dx, dx
        add di, 260d ;sumamos 60
        REPEAT:
            loop CICLO
    POP DI
    POP DX
...
juego_pelota MACRO
LOCAL MOVER_PELOTEXI, MOVER_PELOTAXD, MOVER_PELOTAYU, MOVER_PELOTAYD, EJEY, IMPRIMIR_PELOR 
    cmp PelotaXDir, 0
    je MOVER_PELOTEXI
    cmp PelotaXDir, 1
    je MOVER_PELOTAXD
...
LOCAL CICLO_REP, CICLO_USER, PRE_CICLO_NUM, CICLO_NUM, CMP_NUMS, PRINT_RESULT, NO_PRINT_RESULT, SUMIDERO, SEND_REP, TERMINAR
...
mostrar_top_tiempos_reporte MACRO
    LOCAL CICLO_REP, CICLO_USER, PRE_CICLO_NUM, CICLO_NUM, CMP_NUMS, PRINT_RESULT, NO_PRINT_RESULT, SUMIDERO, SEND_REP, TERMINAR, AVANCE_NUM, SEND_CICLO_NUM
    ;print_num_ARRAY Resultados
    print_string RepLine
    print_char 10d
