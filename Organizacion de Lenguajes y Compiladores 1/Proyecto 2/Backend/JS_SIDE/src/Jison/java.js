...
case 2: //INSTRUCCIONES INSTRUCCION
 ...
 var padre = nodo;
 nodo++
 ASTDot += `node${padre}[label = "INSTRUCCIONES"];\n`;
 ASTDot += `node${padre} -> node${nodos[nodos.length - 2]};\n`;
 ASTDot += `node${padre} -> node${nodos[nodos.length - 1]};\n`;
 nodos.pop()
 nodos.pop()
 nodos.push(padre)
break;
case 3: 
 ...
 nodo++
 ASTDot += `node${padre}[label = "INSTRUCCIONES"];\n`;
 ASTDot += `node${padre} -> node${nodos.pop()};\n`;
 nodos.push(padre)
break;
case 7: case 8: case 10: case 15: case 16: case 17: //ALGO
 ...
 var padre = nodo;
 nodo++
 ASTDot += `node${padre}[label = "INSTRUCCION"];\n`;
 ASTDot += `node${padre} -> node${nodos.pop()};\n`;
 nodos.push(padre)
break;
case 4: case 5: case 6:
            Save(traduccion)
            console.log('Error sintáctico:'+ $$[$0-1] + 'en la linea: ' +this._$.first_line + ', en la columna: ' + this._$.first_column+ 'Se esperaba: '+ yy.parser.hash.expected.join(",")); 
...
case 9: case 11: case 12: case 13: case 14: case 18: case 19: //ALGO ;
 ...
 nodo++
 ASTDot += `node${padre}[label = "INSTRUCCION"];\n`;
 ASTDot += `node${nodo}[label = ";"];\n`;
 ASTDot += `node${padre} -> node${nodos.pop()};\n`;
 ASTDot += `node${padre} -> node${nodo};\n`;
 nodo++
 nodos.push(padre)
break;
case 20: //LLAVEABRIR INSTRUCCIONES LLAVECERRAR
 ...
 var hijo1 = nodo;
 nodo++;
 ASTDot += `node${padre}[label = "BLOQUESENTENCIAS"];\n`;
 ASTDot += `node${hijo0}[label = "{"];\n`;
 ASTDot += `node${hijo1}[label = "}"];\n`;
 ASTDot += `node${padre} -> node${hijo0};\n`;
 ASTDot += `node${padre} -> node${nodos.pop()};\n`;
 ASTDot += `node${padre} -> node${hijo1};\n`;
 nodos.push(padre)
break;
...
case 22: //RDO BLOQUESENTENCIAS RWHILE PARABRIR EXP PARCERRAR 
 ...
 ASTDot += `node${padre}[label = "DOWHILE"];\n`;
 ASTDot += `node${hijo0}[label = "do"];\n`;
 ASTDot += `node${hijo1}[label = "("];\n`;
 ASTDot += `node${hijo2}[label = ")"];\n`;
 ASTDot += `node${hijo3}[label = "while"];\n`;
 ASTDot += `node${padre} -> node${hijo0};\n`;
 ASTDot += `node${padre} -> node${nodos[nodos.length - 2]};\n`;
 ASTDot += `node${padre} -> node${hijo3};\n`;
 ASTDot += `node${padre} -> node${hijo1};\n`;
 ASTDot += `node${padre} -> node${nodos[nodos.length - 1]};\n`;
 ASTDot += `node${padre} -> node${hijo2};\n`;
 nodos.pop()
 nodos.pop()
 nodos.push(padre);
break;
case 23: //RWHILE PARABRIR EXP PARCERRAR BLOQUESENTENCIAS
 ...
 ASTDot += `node${padre}[label = "WHILE"];\n`;
 ASTDot += `node${hijo0}[label = "while"];\n`;
 ASTDot += `node${hijo1}[label = "("];\n`;
 ASTDot += `node${hijo2}[label = ")"];\n`;
...
case 24: //RFOR PARABRIR DECLARACION PUNTOCOMA EXP PUNTOCOMA EXP PARCERRAR BLOQUESENTENCIAS
 ...
 var hijo4 = nodo;
 nodo++;
 ASTDot += `node${padre}[label = "FOR"];\n`;
 ASTDot += `node${hijo0}[label = "for"];\n`;
 ASTDot += `node${hijo1}[label = "("];\n`;
 ASTDot += `node${hijo2}[label = ";"];\n`;
 ASTDot += `node${hijo3}[label = ";"];\n`;
 ASTDot += `node${hijo4}[label = ")"];\n`;

 ASTDot += `node${padre} -> node${hijo0};\n`;
 ASTDot += `node${padre} -> node${hijo1};\n`;
 ASTDot += `node${padre} -> node${nodos[nodos.length - 4]};\n`;
 ASTDot += `node${padre} -> node${hijo2};\n`;
 ASTDot += `node${padre} -> node${nodos[nodos.length - 3]};\n`;
 ASTDot += `node${padre} -> node${hijo3};\n`;
 ASTDot += `node${padre} -> node${nodos[nodos.length - 2]};\n`;
 ASTDot += `node${padre} -> node${hijo4};\n`;
 ASTDot += `node${padre} -> node${nodos[nodos.length - 1]};\n`;
 nodos.pop()
 nodos.pop()
 nodos.pop()
...
case 25:
 ...
 var hijo2 = nodo;
 nodo++
 ASTDot += `node${padre}[label = "IF"];\n`;
 ASTDot += `node${hijo0}[label = "if"];\n`;
 ASTDot += `node${hijo1}[label = "("];\n`;
 ASTDot += `node${hijo2}[label = ")"];\n`;
 ASTDot += `node${padre} -> node${hijo0};\n`;
 ASTDot += `node${padre} -> node${hijo1};\n`;
...
case 28: //RPUBLIC RINTERFACE IDENTIFICADOR BLOQUESENTENCIAS
 ...
 ASTDot += `node${padre}[label = "INTERFACE"];\n`;
 ASTDot += `node${hijo0}[label = "public"];\n`;
 ASTDot += `node${hijo1}[label = "interface"];\n`;
 ASTDot += `node${hijo2}[label = "${$$[$0-1]}"];\n`;
...
case 29: //RPUBLIC RCLASS IDENTIFICADOR BLOQUESENTENCIAS    
 ...
 var hijo7 = nodo;
 nodo++;
 ASTDot += `node${padre}[label = "MAIN"];\n`;
 ASTDot += `node${hijo0}[label = "public"];\n`;
 ASTDot += `node${hijo1}[label = "class"];\n`;
 ASTDot += `node${hijo7}[label = "${$$[$0-1]}"];\n`;
 ASTDot += `node${padre} -> node${hijo0};\n`;
 ASTDot += `node${padre} -> node${hijo1};\n`;
 ASTDot += `node${padre} -> node${hijo7};\n`;
 ASTDot += `node${padre} -> node${nodos.pop()};\n`;
 nodos.push(padre);
break;
case 30: //RPUBLIC RSTATIC RVOID RMAIN PARABRIR RSTRING CORABRIR CORCERRAR IDENTIFICADOR PARCERRAR BLOQUESENTENCIAS
 ...
 ASTDot += `node${padre}[label = "MAIN"];\n`;
 ASTDot += `node${hijo0}[label = "public"];\n`;
 ASTDot += `node${hijo1}[label = "static"];\n`;
 ASTDot += `node${hijo2}[label = "void"];\n`;
 ASTDot += `node${hijo3}[label = "main"];\n`;
 ASTDot += `node${hijo4}[label = "("];\n`;
 ASTDot += `node${hijo5}[label = "String"];\n`;
 ASTDot += `node${hijo6}[label = "["];\n`;
 ASTDot += `node${hijo7}[label = "]"];\n`;
 ASTDot += `node${hijo8}[label = ")"];\n`;
 ASTDot += `node${padre} -> node${hijo0};\n`;
 ASTDot += `node${padre} -> node${hijo1};\n`;
 ASTDot += `node${padre} -> node${hijo2};\n`;
 ASTDot += `node${padre} -> node${hijo3};\n`;
 ASTDot += `node${padre} -> node${hijo4};\n`;
 ASTDot += `node${padre} -> node${hijo5};\n`;
 ASTDot += `node${padre} -> node${hijo6};\n`;
 ASTDot += `node${padre} -> node${hijo7};\n`;
 ASTDot += `node${padre} -> node${hijo8};\n`;
 ASTDot += `node${padre} -> node${nodos.pop()};\n`;
 nodos.push(padre);
break;
case 31: //RPUBLIC TIPO IDENTIFICADOR PARABRIR LISTAPARAMETROSDECLARADOS PARCERRAR
 ...
 var hijo3 = nodo;
 nodo++;
 ASTDot += `node${padre}[label = "FUNCION"];\n`;
 ASTDot += `node${hijo0}[label = "public"];\n`;
 ASTDot += `node${hijo1}[label = "${$$[$0-4]}"];\n`;
 ASTDot += `node${hijo2}[label = "("];\n`;
 ASTDot += `node${hijo3}[label = ")"];\n`;
 ASTDot += `node${padre} -> node${hijo0};\n`;
 ASTDot += `node${padre} -> node${nodos[nodos.length - 2]};\n`;
...
case 33: //IDENTIFICADOR PARABRIR LISTAPARAMETROSENVIADOS PARCERRAR
 ...
 var hijo2 = nodo;
 nodo++;
 ASTDot += `node${padre}[label = "CALL"];\n`;
 ASTDot += `node${hijo0}[label = "("];\n`;
 ASTDot += `node${hijo1}[label = ")"];\n`;
 ASTDot += `node${hijo2}[label = "${$$[$0-3]}"];\n`;
 ASTDot += `node${padre} -> node${hijo2};\n`;
 ASTDot += `node${padre} -> node${hijo0};\n`;
 ASTDot += `node${padre} -> node${nodos.pop()};\n`;
 ASTDot += `node${padre} -> node${hijo1};\n`;
...
case 34: case 35:
 ...
 var hijo6 = nodo;
 nodo++;
 ASTDot += `node${padre}[label = "PRINT"];\n`;
 ASTDot += `node${hijo0}[label = "system"];\n`;
 ASTDot += `node${hijo1}[label = "."];\n`;
 ASTDot += `node${hijo2}[label = "out"];\n`;
 ASTDot += `node${hijo3}[label = "."];\n`;
 ASTDot += `node${hijo4}[label = "println"];\n`;
 ASTDot += `node${hijo5}[label = "("];\n`;
 ASTDot += `node${hijo6}[label = ")"];\n`;
 ASTDot += `node${padre} -> node${hijo0};\n`;
 ASTDot += `node${padre} -> node${hijo1};\n`;
 ASTDot += `node${padre} -> node${hijo2};\n`;
...
case 51: case 64: case 65: case 68: case 69:
 traduccion = this.$ = `${$$[$0]}`;
 nodos.push(nodo)
 ASTDot += `node${nodo}[label = "${$$[$0].replace(/\"/gi,"\\\"")}"]\n`;
 nodo++
 //ASTDot += 'VALUE: '+$$[$0]);
break;
case 39:
...
var hijo0 = nodo;
nodo++;
ASTDot += `node${padre}[label = "ASIGNACION"];\n`;
ASTDot += `node${hijo0}[label = "="];\n`;
ASTDot += `node${nodo}[label = "${$$[$0-2]}"];\n`;
ASTDot += `node${padre} -> node${nodo};\n`;
ASTDot += `node${padre} -> node${hijo0};\n`;
ASTDot += `node${padre} -> node${nodos.pop()};\n`;
nodo++
...
case 43:
 ...
 var padre = nodo;
 nodo++
 ASTDot += `node${padre}[label = "Sentencia"];\n`;
 ASTDot += `node${nodo}[label = "break"];\n`;
 ASTDot += `node${padre} -> node${nodo};\n`;
 nodo++
 nodos.push(padre);
...
case 44:
 ...
 nodo++
 ASTDot += `node${padre}[label = "Sentencia"];\n`;
 ASTDot += `node${nodo}[label = "continue"];\n`;
 ASTDot += `node${padre} -> node${nodo};\n`;
 nodo++
 nodos.push(padre);
break;
...
case 46:
 ...
 ASTDot += `node${padre}[label = "Sentencia"];\n`;
 ASTDot += `node${nodo}[label = "return"];\n`;
 ASTDot += `node${hijo0}[label = "${$$[$0].replace(/\"/gi,"\\\"")}"]\n`;
 ASTDot += `node${padre} -> node${nodo};\n`;
 nodo++
 nodos.push(padre);
break;
case 47:
 ...
 var padre = nodo;
 nodo++;
 ASTDot += `node${padre}[label = "DECLARACION"];\n`;
 ASTDot += `node${padre} -> node${nodos[nodos.length - 2]};\n`;
 ASTDot += `node${padre} -> node${nodos[nodos.length - 1]};\n`;
 nodos.pop()
 nodos.pop()
...
case 66:
 ...
 nodos.push(nodo)
 ASTDot += `node${nodo}[label = "true"]\n`;
 nodo++
break;
case 67:
 traduccion = this.$ = `false`;
 nodos.push(nodo)
 ASTDot += `node${nodo}[label = "false"]\n`;
 nodo++
break;
case 70:
 traduccion = this.$ = `${$$[$0-2]} > ${$$[$0]}`;
